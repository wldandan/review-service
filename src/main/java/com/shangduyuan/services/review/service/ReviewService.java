package com.shangduyuan.services.review.service;
...
import com.shangduyuan.services.review.model.Review;
import com.shangduyuan.services.review.service.util.SetProcTimeBean;
...
public class ReviewService {
    ...
    public List<Review> getReviews(@PathVariable int eventId) {
        ...
        list.add(new Review(eventId, 1, "Author 1", "Subject 1", "Content 1"));
        list.add(new Review(eventId, 2, "Author 2", "Subject 2", "Content 2"));
        list.add(new Review(eventId, 3, "Author 3", "Subject 3", "Content 3"));
